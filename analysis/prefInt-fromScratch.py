...
title="47arg"
tpr="{}-reus.tpr".format(title)
traj="{}-reus-npt-prod-0-trunc-1.xtc".format(title)
...
savetxt('output/prefInt-{}.dat'.format(title), gammaOutputs, header=header, delimiter=' ', fmt='%.3f', comments='') 
